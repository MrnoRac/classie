...
* [`src/classie/`](src/classie/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/classie/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `classie` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/classie/config.cljs) defaults to `true` in
...
```clj
(ns classie.example
  (:require [classie.config :as config])
