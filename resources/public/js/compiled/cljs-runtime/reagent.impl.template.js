...
var G__35105 = o;
goog.object.set(G__35105,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__35106 = o;
goog.object.set(G__35106,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__35139__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__35139 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__35140__i = 0, G__35140__a = new Array(arguments.length -  0);
while (G__35140__i < G__35140__a.length) {G__35140__a[G__35140__i] = arguments[G__35140__i + 0]; ++G__35140__i;}
  args = new cljs.core.IndexedSeq(G__35140__a,0,null);
} 
return G__35139__delegate.call(this,args);};
G__35139.cljs$lang$maxFixedArity = 0;
G__35139.cljs$lang$applyTo = (function (arglist__35141){
var args = cljs.core.seq(arglist__35141);
return G__35139__delegate(args);
});
G__35139.cljs$core$IFn$_invoke$arity$variadic = G__35139__delegate;
return G__35139;
})()
;
} else {
...
var G__35107 = props;
var G__35107__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35107,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35107);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35107__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__35108 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35108,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__35108;
}
})(),id_class);
...
var G__35109 = (cljs.core.count(argv) - first_child);
switch (G__35109) {
case (0):
...
var vec__35114 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35114,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35114,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35114,(2),null);
...
var temp__5757__auto___35145 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___35145 == null)){
} else {
var key_35147 = temp__5757__auto___35145;
(jsprops.key = key_35147);
}
...
var temp__5757__auto___35150 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___35150 == null)){
} else {
var key_35151 = temp__5757__auto___35150;
(jsprops.key = key_35151);
}
...
var temp__5757__auto___35153 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___35153 == null)){
} else {
var key_35154 = temp__5757__auto___35153;
...
var temp__5757__auto___35160 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___35160 == null)){
} else {
var key_35161 = temp__5757__auto___35160;
(jsprops.key = key_35161);
}
...
var temp__5757__auto___35163 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___35163 == null)){
} else {
var key_35164 = temp__5757__auto___35163;
(jsprops.key = key_35164);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35122_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__35122_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__35123 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35123,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35123,(1),null);
...
break;
default:
var G__35170 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__35171 = compiler;
v = G__35170;
compiler = G__35171;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template35129 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template35129 = (function (opts,id,fn_to_element,parse_fn,meta35130){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template35129.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_35131,meta35130__$1){
var self__ = this;
var _35131__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template35129(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta35130__$1));
}));

(reagent.impl.template.t_reagent$impl$template35129.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_35131){
var self__ = this;
var _35131__$1 = this;
return self__.meta35130;
}));

(reagent.impl.template.t_reagent$impl$template35129.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template35129.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template35129.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template35129.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template35129.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template35129.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta35130","meta35130",518776958,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template35129.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template35129.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template35129");

(reagent.impl.template.t_reagent$impl$template35129.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template35129");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template35129.
 */
reagent.impl.template.__GT_t_reagent$impl$template35129 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template35129(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta35130){
return (new reagent.impl.template.t_reagent$impl$template35129(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta35130));
});

}

return (new reagent.impl.template.t_reagent$impl$template35129(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
