...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__38676,k,f){
var vec__38677 = p__38676;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38677,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38677,(1),null);
var loc = vec__38677;
...
var G__38715 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__38715;
continue;
}
break;
...
var G__38716 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__38716;
continue;
} else {
return zloc__$1;
...
var G__38724 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__38724;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__38695){
var vec__38696 = p__38695;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38696,(0),null);
var map__38699 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38696,(1),null);
var map__38699__$1 = cljs.core.__destructure_map(map__38699);
var path = map__38699__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38699__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__38696;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__38701){
var vec__38702 = p__38701;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38702,(0),null);
var map__38705 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38702,(1),null);
var map__38705__$1 = cljs.core.__destructure_map(map__38705);
var path = map__38705__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38705__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__38702;
if(cljs.core.seq(r)){
...
var vec__38709 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38709,(0),null);
var map__38712 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38709,(1),null);
var map__38712__$1 = cljs.core.__destructure_map(map__38712);
var path = map__38712__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38712__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38712__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38712__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38712__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
