...
var i_43381 = (0);
while(true){
if((i_43381 < arr.length)){
(arr[i_43381] = null);

var G__43382 = (i_43381 + (1));
i_43381 = G__43382;
continue;
} else {
}
...
var i_43392 = (self__.level + (1));
while(true){
if((i_43392 <= (new_level + (1)))){
(update[i_43392] = self__.header);

var G__43394 = (i_43392 + (1));
i_43392 = G__43394;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43395 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43395[i]));
} else {
x__$2.forward.push((((i < links_43395.length))?(links_43395[i]):null));
}

if((i < links_43395.length)){
(links_43395[i] = x__$2);
} else {
links_43395.push(x__$2);
}
...
var i_43401 = (0);
while(true){
if((i_43401 <= self__.level)){
var links_43402 = (update[i_43401]).forward;
if((x__$1 === (((i_43401 < links_43402.length))?(links_43402[i_43401]):null))){
(links_43402[i_43401] = (x__$1.forward[i_43401]));

var G__43403 = (i_43401 + (1));
i_43401 = G__43403;
continue;
} else {
var G__43404 = (i_43401 + (1));
i_43401 = G__43404;
continue;
}
} else {
...
var G__43406 = nx;
var G__43407 = (level__$1 - (1));
x = G__43406;
level__$1 = G__43407;
continue;
} else {
var G__43408 = x;
var G__43409 = (level__$1 - (1));
x = G__43408;
level__$1 = G__43409;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__43411 = nx;
var G__43412 = (level__$1 - (1));
x = G__43411;
level__$1 = G__43412;
continue;
} else {
var G__43413 = x;
var G__43414 = (level__$1 - (1));
x = G__43413;
level__$1 = G__43414;
continue;
}
