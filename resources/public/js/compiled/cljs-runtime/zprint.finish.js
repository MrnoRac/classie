...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__37525_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__37525_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__37525_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__37530){
var vec__37531 = p__37530;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37531,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37531,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__37534,s,color,element,idx){
var map__37535 = p__37534;
var map__37535__$1 = cljs.core.__destructure_map(map__37535);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37535__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37535__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37535__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__37538 = (function (){var or__4223__auto__ = color;
...
var fexpr__37537 = (function (){var G__37539 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__37539) : style_map.call(null,G__37539));
})();
return (fexpr__37537.cljs$core$IFn$_invoke$arity$1 ? fexpr__37537.cljs$core$IFn$_invoke$arity$1(G__37538) : fexpr__37537.call(null,G__37538));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__37540){
var vec__37541 = p__37540;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37541,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37541,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37541,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__37545){
var vec__37546 = p__37545;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37546,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37546,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37546,(2),null);
...
var G__37624 = cljs.core.next(ssv);
var G__37625 = (this_ssv == null);
var G__37626 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__37627 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__37624;
doing_nil_QMARK_ = G__37625;
last_elide = G__37626;
out = G__37627;
continue;
}
...
var vec__37557 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37557,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37557,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37557,(2),null);
...
var G__37628 = cljs.core.next(remaining_cvec);
var G__37629 = new_idx;
var G__37630 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__37628;
idx = G__37629;
out = G__37630;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__37574,cursor_vec){
var vec__37575 = p__37574;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37575,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37575,(1),null);
var focus_vec = vec__37575;
...
var vec__37579 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37579,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37579,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__37583){
var vec__37584 = p__37583;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37584,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37584,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__37592,existing_count){
var vec__37593 = p__37592;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37593,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37593,(1),null);
...
return cljs.core.filterv((function (p1__37588_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__37588_SHARP_))));
...
var vec__37601 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37601,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37601,(1),null);
var cvec_element = vec__37601;
if((cvec_element == null)){
var G__37660 = cljs.core.next(cvec_nl);
var G__37661 = (idx + (1));
var G__37662 = start;
var G__37663 = out;
cvec_nl = G__37660;
...
var G__37664 = cljs.core.next(cvec_nl);
var G__37665 = (idx + (1));
var G__37666 = idx;
var G__37667 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__37664;
idx = G__37665;
start = G__37666;
out = G__37667;
...
var G__37669 = cljs.core.next(cvec_nl);
var G__37670 = (idx + (1));
var G__37671 = (idx + (1));
var G__37672 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__37669;
idx = G__37670;
start = G__37671;
out = G__37672;
...
var G__37673 = cljs.core.next(cvec_nl);
var G__37674 = (idx + (1));
var G__37675 = idx;
var G__37676 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__37673;
idx = G__37674;
start = G__37675;
out = G__37676;
...
var G__37678 = cljs.core.next(cvec_nl);
var G__37679 = (idx + (1));
var G__37680 = start;
var G__37681 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__37678;
idx = G__37679;
start = G__37680;
out = G__37681;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37606_SHARP_,p2__37605_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__37605_SHARP_)){
return cljs.core.reduced(p1__37606_SHARP_);
} else {
return (p1__37606_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__37608,p__37609){
var vec__37610 = p__37608;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37610,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37610,(1),null);
var vec__37613 = p__37609;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37613,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37613,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__37618,cvec,focus_vec){
var map__37619 = p__37618;
var map__37619__$1 = cljs.core.__destructure_map(map__37619);
var options = map__37619__$1;
var map__37620 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37619__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__37620__$1 = cljs.core.__destructure_map(map__37620);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37620__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37620__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37620__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37617_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__37617_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
