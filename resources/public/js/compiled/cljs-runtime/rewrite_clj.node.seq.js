...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k37980,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__38001 = k37980;
var G__38001__$1 = (((G__38001 instanceof cljs.core.Keyword))?G__38001.fqn:null);
switch (G__38001__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k37980,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__38006){
var vec__38007 = p__38006;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38007,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38007,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__37979){
var self__ = this;
var G__37979__$1 = this;
return (new cljs.core.RecordIter((0),G__37979__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37981,other37982){
var self__ = this;
var this37981__$1 = this;
return (((!((other37982 == null)))) && ((((this37981__$1.constructor === other37982.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37981__$1.tag,other37982.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37981__$1.wrap_fn,other37982.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37981__$1.wrap_length,other37982.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37981__$1.seq_fn,other37982.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37981__$1.children,other37982.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37981__$1.__extmap,other37982.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__38049 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__38049) : self__.seq_fn.call(null,G__38049));
}));
...
var self__ = this;
var this$__$1 = this;
var G__38057 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__38057) : self__.wrap_fn.call(null,G__38057));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k37980){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__37979){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__38076 = cljs.core.keyword_identical_QMARK_;
var expr__38078 = k__4481__auto__;
if(cljs.core.truth_((pred__38076.cljs$core$IFn$_invoke$arity$2 ? pred__38076.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__38078) : pred__38076.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__38078)))){
return (new rewrite_clj.node.seq.SeqNode(G__37979,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38076.cljs$core$IFn$_invoke$arity$2 ? pred__38076.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__38078) : pred__38076.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__38078)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__37979,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38076.cljs$core$IFn$_invoke$arity$2 ? pred__38076.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__38078) : pred__38076.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__38078)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__37979,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38076.cljs$core$IFn$_invoke$arity$2 ? pred__38076.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__38078) : pred__38076.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__38078)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__37979,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38076.cljs$core$IFn$_invoke$arity$2 ? pred__38076.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__38078) : pred__38076.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__38078)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__37979,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__37979),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__37979){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__37979,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__37987){
var extmap__4512__auto__ = (function (){var G__38088 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__37987,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__37987)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38088);
} else {
return G__38088;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__37987),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__37987),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__37987),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__37987),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__37987),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__38096_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__38096_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__38102_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__38102_SHARP_);
}),children);
});
