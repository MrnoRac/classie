...
var G__38897 = (function (){var G__38898 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__38898) : f.call(null,G__38898));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__38897) : rewrite_clj.node.coerce.call(null,G__38897));
});
/**
...
var len__4829__auto___38922 = arguments.length;
var i__4830__auto___38923 = (0);
while(true){
if((i__4830__auto___38923 < len__4829__auto___38922)){
args__4835__auto__.push((arguments[i__4830__auto___38923]));

var G__38924 = (i__4830__auto___38923 + (1));
i__4830__auto___38923 = G__38924;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__38899_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__38899_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq38900){
var G__38901 = cljs.core.first(seq38900);
var seq38900__$1 = cljs.core.next(seq38900);
var G__38902 = cljs.core.first(seq38900__$1);
var seq38900__$2 = cljs.core.next(seq38900__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38901,G__38902,seq38900__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__38907 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__38907) : str_fn.call(null,G__38907));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__38908 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__38908) : str_fn.call(null,G__38908));
})()):null)));
...
var G__38911 = rewrite_clj.zip.base.tag(zloc);
var G__38911__$1 = (((G__38911 instanceof cljs.core.Keyword))?G__38911.fqn:null);
switch (G__38911__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__38909_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38909_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__38910_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38910_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38911__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__38921 = rewrite_clj.zip.base.tag(zloc);
var G__38921__$1 = (((G__38921 instanceof cljs.core.Keyword))?G__38921.fqn:null);
switch (G__38921__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__38920_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38920_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38921__$1)].join('')));
