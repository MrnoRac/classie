 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__32464){
var vec__32465 = p__32464;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32465,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32465,(1),null);
return (function (s){
...
var len__4829__auto___32491 = arguments.length;
var i__4830__auto___32492 = (0);
while(true){
if((i__4830__auto___32492 < len__4829__auto___32491)){
args__4835__auto__.push((arguments[i__4830__auto___32492]));

var G__32493 = (i__4830__auto___32492 + (1));
i__4830__auto___32492 = G__32493;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__32472_SHARP_){
return (p1__32472_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__32472_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__32472_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq32473){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq32473));
}));
...
var map__32477 = temp__5751__auto__;
var map__32477__$1 = cljs.core.__destructure_map(map__32477);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32477__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32477__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32477__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__32496 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__32497 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__32479 = tag;
