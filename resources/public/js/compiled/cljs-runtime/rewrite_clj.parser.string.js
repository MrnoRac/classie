...
if((c === "\n")){
var G__38476 = escape_QMARK_;
var G__38477 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__38476;
lines = G__38477;
continue;
} else {
buf.append(c);

var G__38478 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__38479 = lines;
escape_QMARK_ = G__38478;
lines = G__38479;
continue;
...
var G__38473 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__38473) : rewrite_clj.node.string_node.call(null,G__38473));
});
...
var G__38474 = cljs.core.re_pattern(regex);
var G__38475 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__38474,G__38475) : rewrite_clj.node.token_node.call(null,G__38474,G__38475));
});
