...
var syms = (function (){var iter__4622__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__37836(s__37837){
return (new cljs.core.LazySeq(null,(function (){
var s__37837__$1 = s__37837;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__37837__$1);
if(temp__5753__auto__){
var s__37837__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37837__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__37837__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__37839 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__37838 = (0);
while(true){
if((i__37838 < size__4621__auto__)){
var i = cljs.core._nth(c__4620__auto__,i__37838);
...
cljs.core.chunk_append(b__37839,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__37942 = (i__37838 + (1));
i__37838 = G__37942;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37839),rewrite_clj$node$fn$fn_walk_$_iter__37836(cljs.core.chunk_rest(s__37837__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37839),null);
}
} else {
var i = cljs.core.first(s__37837__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__37836(cljs.core.rest(s__37837__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__37834_SHARP_){
var or__4223__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__37834_SHARP_);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return p1__37834_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k37845,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k37845,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__37859){
var vec__37863 = p__37859;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37863,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37863,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__37844){
var self__ = this;
var G__37844__$1 = this;
return (new cljs.core.RecordIter((0),G__37844__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37846,other37847){
var self__ = this;
var this37846__$1 = this;
return (((!((other37847 == null)))) && ((((this37846__$1.constructor === other37847.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37846__$1.children,other37847.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37846__$1.__extmap,other37847.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k37845){
var self__ = this;
var this__4479__auto____$1 = this;
var G__37898 = k37845;
var G__37898__$1 = (((G__37898 instanceof cljs.core.Keyword))?G__37898.fqn:null);
switch (G__37898__$1) {
case "children":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k37845);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__37844){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__37903 = cljs.core.keyword_identical_QMARK_;
var expr__37904 = k__4481__auto__;
if(cljs.core.truth_((pred__37903.cljs$core$IFn$_invoke$arity$2 ? pred__37903.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__37904) : pred__37903.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__37904)))){
return (new rewrite_clj.node.fn.FnNode(G__37844,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__37844),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__37844){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__37844,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__37849){
var extmap__4512__auto__ = (function (){var G__37921 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__37849,new cljs.core.Keyword(null,"children","children",-940561982));
...
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__37849),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
