...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__45243){
var map__45244 = p__45243;
var map__45244__$1 = cljs.core.__destructure_map(map__45244);
var ast = map__45244__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45244__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
return cljs.core.boolean$((function (){var and__4221__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_(ast);
if(and__4221__auto__){
var G__45247 = (function (){var or__4223__auto__ = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(ast);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
if(cljs.core.truth_((function (){var fexpr__45249 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"var","var",-769682797),null,new cljs.core.Keyword(null,"local","local",-1497766724),null], null), null);
return (fexpr__45249.cljs$core$IFn$_invoke$arity$1 ? fexpr__45249.cljs$core$IFn$_invoke$arity$1(op) : fexpr__45249.call(null,op));
})())){
...
var fexpr__45246 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"seq","seq",-177272256,null),"null",new cljs.core.Symbol(null,"boolean","boolean",-278886877,null),"null"], null), null);
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__45269_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__45269_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__45275 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__45275,local);
} else {
return G__45275;
}
});
...
var map__45276 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__45276__$1 = cljs.core.__destructure_map(map__45276);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45276__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45276__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var map__45278 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__45278__$1 = cljs.core.__destructure_map(map__45278);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45278__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45278__$1,new cljs.core.Keyword(null,"name","name",1843675177));
