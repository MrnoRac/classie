...
var len__4829__auto___28612 = arguments.length;
var i__4830__auto___28613 = (0);
while(true){
if((i__4830__auto___28613 < len__4829__auto___28612)){
args__4835__auto__.push((arguments[i__4830__auto___28613]));

var G__28614 = (i__4830__auto___28613 + (1));
i__4830__auto___28613 = G__28614;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28533){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28534,G__28535,seq28533__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28561_SHARP_){
return (!((cljs.core.meta(p1__28561_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28576__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28577){var _e__27775__auto__ = e28577;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e28579){var _e__27775__auto__ = e28579;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28584 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28585 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28585);

try{var map__28589 = opts;
var map__28589__$1 = cljs.core.__destructure_map(map__28589);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28589__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28584);
}});
...
var temp__5751__auto___28647 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___28647)){
var managed_print_level_28656 = temp__5751__auto___28647;
var _STAR_print_level_STAR__orig_val__28591_28657 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28592_28658 = managed_print_level_28656;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28592_28658);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28590_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28590_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28591_28657);
}} else {
job_fn();
}
