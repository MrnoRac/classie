...
var G__28504 = devtools.prefs.pref(v);
v = G__28504;
continue;
} else {
return v;
...
}catch (e28404){var _e__27775__auto__ = e28404;
return false;
}})();
...
}catch (e28415){var _e__27775__auto__ = e28415;
return false;
}})();
...
}catch (e28418){var _e__27775__auto__ = e28418;
return false;
}}
}
});
...
var vec__28443 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28443,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28443,(1),null);
...
return cljs.core.some((function (p1__28454_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28454_SHARP_);
}),template);
});
