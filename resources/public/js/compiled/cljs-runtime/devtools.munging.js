...
var o28072 = temp__5751__auto__;
var temp__5751__auto____$1 = (o28072["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o28073 = temp__5751__auto____$1;
return (o28073["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27759__auto__ = f;
return (o__27759__auto__["toString"]).call(o__27759__auto__);
} else {
return "";
}
}catch (e28079){var _ = e28079;
return "";
}});
...
try{var o__27759__auto___28377 = t;
(o__27759__auto___28377["cljs$lang$ctorPrWriter"]).call(o__27759__auto___28377,t,writer);
}catch (e28087){var __28380 = e28087;
}
...
var char_code = (function (){var o__27759__auto__ = (new String(char$));
return (o__27759__auto__["charCodeAt"]).call(o__27759__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27759__auto__ = String;
return (o__27759__auto__["fromCharCode"]).call(o__27759__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28098 = num_code;
switch (G__28098) {
case (1):
return (185);
...
var o__27759__auto__ = String;
return (o__27759__auto__["fromCharCode"]).call(o__27759__auto__,superscript_code);
});
/**
...
}catch (e28117){var _e__27775__auto__ = e28117;
return false;
}})())){
...
var vec__28119 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28119,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28144){
var vec__28145 = p__28144;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28145,(0),null);
...
var G__28401 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28402 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28401;
remaining_tokens = G__28402;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28142){
var G__28143 = cljs.core.first(seq28142);
var seq28142__$1 = cljs.core.next(seq28142);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28143,seq28142__$1);
}));
...
var vec__28154 = cljs.core.split_with((function (p1__28153_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28153_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28154,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28154,(1),null);
...
var vec__28166 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28166,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28166,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28409 = cljs.core.rest(remaining_tokens);
var G__28410 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28409;
name_tokens = G__28410;
continue;
} else {
...
var vec__28190 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28190,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28190,(1),null);
var vec__28193 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28193,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28193,(1),null);
var vec__28196 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28196,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28196,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28196,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28196,(3),null);
...
var vec__28202 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28202,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28202,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28202,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28202,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28202,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28202,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__28205 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28205,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28205,(1),null);
var vec__28208 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28208,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28208,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28215 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28215) : devtools.munging.parse_fn_info_deep.call(null,G__28215));
})()));
}
} else {
return fn_info;
...
var G__28448 = (arity + (1));
var G__28449 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28217){
var vec__28218 = p__28217;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28218,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28218,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28231_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28231_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28232_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28232_SHARP_);
}),sorted_infos);
...
var G__28463 = (i__4830__auto___28460 + (1));
i__4830__auto___28460 = G__28463;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28242){
var vec__28243 = p__28242;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28243,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28233){
var G__28234 = cljs.core.first(seq28233);
var seq28233__$1 = cljs.core.next(seq28233);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28234,seq28233__$1);
}));
...
var map__28268 = options;
var map__28268__$1 = cljs.core.__destructure_map(map__28268);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28268__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28268__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28268__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28268__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28269 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28269,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28269,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28269,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28269,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28269,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28269,(5),null);
...
var o__27759__auto__ = f;
return (o__27759__auto__["getBasis"]).call(o__27759__auto__);
});
/**
...
}catch (e28278){var _e__27775__auto__ = e28278;
...
var G__28501 = (obj[cljs.core.first(path)]);
var G__28502 = cljs.core.rest(path);
obj = G__28501;
path = G__28502;
continue;
} else {
...
var _STAR_ = (function (accum,p__28316){
var vec__28320 = p__28316;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28320,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28320,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28343){
var vec__28344 = p__28343;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28344,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28344,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28344,(2),null);
...
var post_process = (function (p__28356){
var vec__28357 = p__28356;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28357,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28357,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28355_SHARP_){
return (obj[cljs.core.first(p1__28355_SHARP_)]);
}),sorted_matches);
