...
return [(function (){var pred__35263 = cljs.core.instance_QMARK_;
var expr__35264 = reactive_val;
if(cljs.core.truth_((pred__35263.cljs$core$IFn$_invoke$arity$2 ? pred__35263.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__35264) : pred__35263.call(null,reagent.ratom.RAtom,expr__35264)))){
return "ra";
} else {
if(cljs.core.truth_((pred__35263.cljs$core$IFn$_invoke$arity$2 ? pred__35263.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__35264) : pred__35263.call(null,reagent.ratom.RCursor,expr__35264)))){
return "rc";
} else {
if(cljs.core.truth_((pred__35263.cljs$core$IFn$_invoke$arity$2 ? pred__35263.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__35264) : pred__35263.call(null,reagent.ratom.Reaction,expr__35264)))){
return "rx";
} else {
if(cljs.core.truth_((pred__35263.cljs$core$IFn$_invoke$arity$2 ? pred__35263.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__35264) : pred__35263.call(null,reagent.ratom.Track,expr__35264)))){
return "tr";
} else {
return "other";
}
