...
var G__38511 = clojure.zip.node(loc);
var fexpr__38510 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38510.cljs$core$IFn$_invoke$arity$1 ? fexpr__38510.cljs$core$IFn$_invoke$arity$1(G__38511) : fexpr__38510.call(null,G__38511));
});
/**
...
var G__38514 = clojure.zip.node(loc);
var fexpr__38513 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38513.cljs$core$IFn$_invoke$arity$1 ? fexpr__38513.cljs$core$IFn$_invoke$arity$1(G__38514) : fexpr__38513.call(null,G__38514));
} else {
...
var fexpr__38527 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38527.cljs$core$IFn$_invoke$arity$2 ? fexpr__38527.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__38527.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__38536 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38536,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38536,(1),null);
var vec__38539 = clojure.zip.children(loc);
...
var vec__38543 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38543,(0),null);
var map__38546 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38543,(1),null);
var map__38546__$1 = cljs.core.__destructure_map(map__38546);
var path = map__38546__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38546__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38546__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38546__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38546__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38546__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__38559 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38559,(0),null);
var map__38562 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38559,(1),null);
var map__38562__$1 = cljs.core.__destructure_map(map__38562);
var path = map__38562__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38562__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__38563 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38562__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__38564 = cljs.core.seq(vec__38563);
var first__38565 = cljs.core.first(seq__38564);
var seq__38564__$1 = cljs.core.next(seq__38564);
var r = first__38565;
var rnext = seq__38564__$1;
var rs = vec__38563;
...
var vec__38566 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38566,(0),null);
var map__38569 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38566,(1),null);
var map__38569__$1 = cljs.core.__destructure_map(map__38569);
var path = map__38569__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38569__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38569__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return r;
} else {
...
var vec__38575 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38575,(0),null);
var map__38578 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38575,(1),null);
var map__38578__$1 = cljs.core.__destructure_map(map__38578);
var path = map__38578__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38578__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38578__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
...
var vec__38590 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38590,(0),null);
var map__38593 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38590,(1),null);
var map__38593__$1 = cljs.core.__destructure_map(map__38593);
var path = map__38593__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38593__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38593__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__38597 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38597,(0),null);
var map__38600 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38597,(1),null);
var map__38600__$1 = cljs.core.__destructure_map(map__38600);
var path = map__38600__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38600__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__38615 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38615,(0),null);
var map__38618 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38615,(1),null);
var map__38618__$1 = cljs.core.__destructure_map(map__38618);
var path = map__38618__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38618__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var len__4829__auto___38659 = arguments.length;
var i__4830__auto___38660 = (0);
while(true){
if((i__4830__auto___38660 < len__4829__auto___38659)){
args__4835__auto__.push((arguments[i__4830__auto___38660]));

var G__38661 = (i__4830__auto___38660 + (1));
i__4830__auto___38660 = G__38661;
continue;
} else {
}
break;
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38628,G__38629,seq38627__$2);
}));
...
var G__38666 = clojure.zip.rightmost(child);
loc__$1 = G__38666;
continue;
} else {
return loc__$1;
...
var vec__38633 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38633,(0),null);
var map__38636 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38633,(1),null);
var map__38636__$1 = cljs.core.__destructure_map(map__38636);
var path = map__38636__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38636__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38636__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38636__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38636__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__38668 = clojure.zip.rightmost(child);
loc__$1 = G__38668;
continue;
} else {
return loc__$1;
