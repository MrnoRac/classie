...
}catch (e30914){var _e__27775__auto__ = e30914;
return false;
...
}catch (e30916){var _e__27775__auto__ = e30916;
return false;
...
}catch (e30918){var _e__27775__auto__ = e30918;
return false;
...
}catch (e30920){var _e__27775__auto__ = e30920;
return false;
...
}catch (e30922){var _e__27775__auto__ = e30922;
return false;
}})())){
...
}catch (e30924){var _e__27775__auto__ = e30924;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__30926 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30927 = (function (){var or__4223__auto__ = config;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30927);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30926);
}});
});
...
while (G__30930__i < G__30930__a.length) {G__30930__a[G__30930__i] = arguments[G__30930__i + 0]; ++G__30930__i;}
  args = new cljs.core.IndexedSeq(G__30930__a,0,null);
} 
