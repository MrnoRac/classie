...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__32065){
var map__32066 = p__32065;
var map__32066__$1 = cljs.core.__destructure_map(map__32066);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32066__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32066__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32066__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32066__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__32069_32098 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__32070_32099 = null;
var count__32071_32100 = (0);
var i__32072_32101 = (0);
while(true){
if((i__32072_32101 < count__32071_32100)){
var vec__32084_32102 = chunk__32070_32099.cljs$core$IIndexed$_nth$arity$2(null,i__32072_32101);
var k_32103 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32084_32102,(0),null);
var cb_32104 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32084_32102,(1),null);
try{var G__32089_32105 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_32104.cljs$core$IFn$_invoke$arity$1 ? cb_32104.cljs$core$IFn$_invoke$arity$1(G__32089_32105) : cb_32104.call(null,G__32089_32105));
}catch (e32087){var e_32106 = e32087;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_32103,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_32106], 0));
}

var G__32107 = seq__32069_32098;
var G__32108 = chunk__32070_32099;
var G__32109 = count__32071_32100;
var G__32110 = (i__32072_32101 + (1));
seq__32069_32098 = G__32107;
chunk__32070_32099 = G__32108;
count__32071_32100 = G__32109;
i__32072_32101 = G__32110;
continue;
} else {
var temp__5753__auto___32111 = cljs.core.seq(seq__32069_32098);
if(temp__5753__auto___32111){
var seq__32069_32112__$1 = temp__5753__auto___32111;
if(cljs.core.chunked_seq_QMARK_(seq__32069_32112__$1)){
var c__4649__auto___32113 = cljs.core.chunk_first(seq__32069_32112__$1);
var G__32114 = cljs.core.chunk_rest(seq__32069_32112__$1);
var G__32115 = c__4649__auto___32113;
var G__32116 = cljs.core.count(c__4649__auto___32113);
var G__32117 = (0);
seq__32069_32098 = G__32114;
chunk__32070_32099 = G__32115;
count__32071_32100 = G__32116;
i__32072_32101 = G__32117;
continue;
} else {
var vec__32090_32118 = cljs.core.first(seq__32069_32112__$1);
var k_32119 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32090_32118,(0),null);
var cb_32120 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32090_32118,(1),null);
try{var G__32094_32121 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_32120.cljs$core$IFn$_invoke$arity$1 ? cb_32120.cljs$core$IFn$_invoke$arity$1(G__32094_32121) : cb_32120.call(null,G__32094_32121));
}catch (e32093){var e_32122 = e32093;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_32119,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_32122], 0));
}

var G__32123 = cljs.core.next(seq__32069_32112__$1);
var G__32124 = null;
var G__32125 = (0);
var G__32126 = (0);
seq__32069_32098 = G__32123;
chunk__32070_32099 = G__32124;
count__32071_32100 = G__32125;
i__32072_32101 = G__32126;
continue;
}
} else {
}
